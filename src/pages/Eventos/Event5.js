...
export default function Event5() {
  const navigation = useNavigation(Event5);
 return (
   <View style={styles.container}>
     <View style={styles.swiperContent}>
        <SwiperComponent
        cover={require('../../../assets/pv4.png')}
        cover2={require('../../../assets/pv5.png')}
        cover3={require('../../../assets/pv6.png')}
        />
     </View>

    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.text1}>Reunião Waze</Text>
      </View>
